    ...
    return (
        ...
        <div className='w-[100%] lg:w-1/2 lg:h-96 flex justify-center lg:flex-col lg:justify-start'>
            <div className="flex lg:justify-center xl:mt-72">
                <div className="xl:shadow-2xl xl:shadow-black xl:w-[500px] lg:flex lg:justify-center xl:h-[200px] lg:items-end rounded-[30px]">
                    <div className="w-[100%] flex justify-center  xl:w-1/2 xl:p-6 ">
